...
public class MavenPlugin {
	...
	public static class ExecutionBuilder {
		...
		private @Nullable ConfigurationBuilder configurationCustomization;
	...
	public static final class Execution {
		...
		private Execution(String id, @Nullable String phase, List<String> goals, @Nullable Configuration configuration,
		 ...
		 * @return the execution phase or {@code null}
		 */
