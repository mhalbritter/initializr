...
public class AnnotationContainer {
	...
	/**
	 * Whether this container has a repeatable annotation with the specified class name.
	 * @param className the class name of an annotation
	 * @return whether this container has the annotation
	 */
	 ...
	 * {@link #addRepeatable(ClassName, Consumer)}
	 */
	@Deprecated(forRemoval = true)
	public void add(ClassName className, Consumer<Builder> annotation) {
		if (hasRepeatable(className)) {
			throw new IllegalArgumentException(
					"%s has already been used as a repeatable annotation".formatted(className));
		}
	 ...
	 * @throws IllegalStateException if the annotation already has been added as a
	...
	public boolean addSingle(ClassName className, Consumer<Builder> annotation) {
		...
		if (hasRepeatable(className)) {
			throw new IllegalStateException("%s has already been used as a repeatable annotation".formatted(className));
		}
	...
	/**
	 * Customizes a single annotation if it exists. This method does nothing if the
	...
	/**
	 * Adds a repeatable annotation.
	 * @param className the class name of an annotation
	 * @throws IllegalStateException if the annotation already has been added as a single
	 * annotation
	 */
	...
	/**
	 * Remove a repeatable annotation.
	 * @param className the class name of an annotation
	 * @return whether the annotation has been removed
	 */
