...
public class MavenProfileActivation {
	 ...
	 * default value.
	 * @return {@code true} to active the profile if no other profile is active or
	 * {@code null}
	 */
	...
	public static final class Os {
		 ...
		 * @return the name of the OS or {@code null}
		 */
		 ...
		 * @return the family of OS or {@code null}
		 */
		 ...
		 * @return the cpu architecture of the OS or {@code null}
		 */
		 ...
		 * @return the version of the OS or {@code null}
		 */
	...
	public static final class File {
		 ...
		 * @return the file that should exist or {@code null}
		 */
		 ...
		 * {@code null}.
		 * @return the file that should be missing or {@code null}
		 */
